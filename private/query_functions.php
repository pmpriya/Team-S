...
function find_investigations_by_id($patient_ID) {
  ...
  function update_investigation($patient_ID, $date, $BiliTD, $AST, $ALT, $ALP, $GGT, $Prot, $Alb, $CK, $HbHct, $WCC, $Neutro, $Platelets, $CRP, $ESR, $PTINR, $APTR, $Fibrinogen, $Cortisol, $Urea, $Creatinine){
    ...
    $sql .= "ALT= ' " . db_escape($db, $ALT) . "', ";
    $sql .= "ALP= ' " . db_escape($db, $ALP) . "', ";
    $sql .= "GGT= ' " . db_escape($db, $GGT) . "', ";
    $sql .= "Prot= ' " . db_escape($db, $Prot) . "', ";
    $sql .= "Alb= ' " . db_escape($db, $Alb) . "', ";
    $sql .= "CK= ' " . db_escape($db, $CK) . "', ";
    $sql .= "HbHct= ' " . db_escape($db, $HbHct) . "', ";
    $sql .= "WCC= ' " . db_escape($db, $WCC) . "', ";
    $sql .= "Neutro= ' " . db_escape($db, $Neutro) . "', ";
    $sql .= "Platelets= ' " . db_escape($db, $Platelets) . "', ";
    $sql .= "CRP= ' " . db_escape($db, $CRP) . "', ";
    $sql .= "ESR= ' " . db_escape($db, $ESR) . "', ";
    $sql .= "PTINR= ' " . db_escape($db, $PTINR) . "', ";
    $sql .= "APTR= ' " . db_escape($db, $APTR) . "', ";
    $sql .= "Fibrinogen= ' " . db_escape($db, $Fibrinogen) . "', ";
    $sql .= "Cortisol= ' " . db_escape($db, $Cortisol) . "', ";
    $sql .= "Urea= ' " . db_escape($db, $Urea) . "', ";
    $sql .= "Creatinine= ' " . db_escape($db, $Creatinine) . "' ";
    $sql .= "WHERE id= ' " . db_escape($db, $id) . " AND " ."date= ' " . db_escape($db, $date) . "' ";
