...

{
    ...
    public function registerPatientEmpty(AcceptanceTester $I) 
    {
        ...
        $I->click('Submit');
        $I->seeCurrentUrlEquals('/Team-S/public/patient/new.php');
    ...
    public function nameWrongFormat(AcceptanceTester $I)
    {
        ...
        $I->fillField('gpnumber',07245166);
        $I->click('Submit');
        $I->canSeeInCurrentUrl('/patient/new.php');
  ...
  /* 
    ...
    public function editPatientEmpty(AcceptanceTester $I)
    {
        ...
        $I->seeCurrentUrlEquals('/Team-S/public/patient/edit.php');
    ...
    {
        $I->wantTo("verify");
        $I->amOnPage('/patient/edit.php?id=158');
        ...
        $I->click('Submit Changes');
        $I->seeCurrentUrlEquals('/Team-S/public/patient/show.php');
