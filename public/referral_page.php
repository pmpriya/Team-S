...
<form action="<?php echo url_for("/referral_page.php"); ?>" method="post">
 <!-- Consultant Name -->
    ...
    <label>Consultant Name </label>
       <input type="text" name="consultant_name" placeholder="Required" required>
      </div>
  ...
  <div class="field-column">
    <label>Organisation Hospital Name</label>
     <input type="text" name="organisation_hospital_name"  placeholder="Required" required>
  </div>

 <div class="field-column">
    <label>Organisation Hospital Number</label>
     <input type="number" name="organisation_hospital_no" placeholder="Required" required>
  </div>
