...
$result = insert_investigation($investigation);
if ($result == true ){
    //find what is the  id
    ...
    //display blank investigation form
    $investigation =[];
    $investigation['date'] = '';
    $investigation['Bili T/D'] = '';
    $investigation['AST'] = '';
    $investigation['ALT'] = '';
    $investigation['ALP'] = '';
    $investigation['GGT']= '';
    ...
    $investigation['Alb'] = '';
    $investigation['CK'] = '';
    $investigation['Hb/Hct'] = '';
    $investigation['WCC'] = '';
    $investigation['Neutro'] = '';
    $investigation['Platelets'] = '';
    $investigation['CRP'] = '';
    $investigation['ESR'] = '';
    $investigation['PT/INR'] = '';
    $investigation['APTR'] = '';
...
<?php $patient_ID = GET['patient_ID']?? '1';?>
...
<form action= "<?php echo url_for('/investigations/new.php'); ?> " method="post">
    <d1>
        <dt> Date </dt>
        <dd> <input type="text" name= "date" value = "<?php echo $investigation['date'];?> " /> </dd>
    </dl> 
    <d1>
        <dt> Bili T/D </dt>
